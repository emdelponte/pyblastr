...
> A  <u>database</u> of information on characterized fungal strains of <i>Pyricularia</i>, the genus name for a complex of species that cause blast symptoms on both leaves and reproductive organs of agriculturally important Poacea (eg. wheat blast) and grasses in general, including turfgrass. 
...
<h3>Who are we?</h3>
><b>Pyblastr</b> was created during the conduction of PhD research projects at the Plant Disease Epidemiology Laboratory (Dr. Del Ponte) in collaboration with Dr. Farman (University of Kentucky). The first version was released on February 2020 and is expected to be continuously updated. 
