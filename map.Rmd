...
wb_all <- wb_all %>% 
  dplyr::select(labcode, year, lat, lon, country, state_province, county_municipality, collector, host_binomial, py_binomial, py_lineage, wheat)
...
filter_select("py_species", "Pyricularia species", sd, ~ py_binomial),
